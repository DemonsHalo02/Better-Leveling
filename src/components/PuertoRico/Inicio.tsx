...
export default function Inicio() {
  ...
  const koreanLevels = ["Basics", "Conversational", "Comfortable", "Immersion Ready", "Travel Fluent"];
    ...
    <div className="space-y-6">
      ...
      <div className="group bg-gradient-to-br from-[#ce1126]/90 via-[#0a3d8f]/80 to-[#050811] rounded-3xl p-6 sm:p-8 shadow-2xl shadow-[#ce1126]/20 border border-white/10 relative overflow-hidden transition-all duration-500 hover:shadow-[#ce1126]/40 backdrop-blur-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-zinc-200 font-medium text-sm sm:text-lg mb-8 tracking-wide drop-shadow-sm">
            10-Year Growth Plan: Full-Stack Dev + Art + Content + Korean 🎯
          </p>
      ...
      <div className="bg-[#11182c]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 sm:p-8 shadow-xl">
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-8">
          <div className="space-y-8">
            ...
            <ProgressBar title="🇪🇸 Korean (Casual)" current={currentKoreanLevel} max={5} color="from-[#0a3d8f] to-[#00f0ff]" labelOverride={currentKoreanLevel === 0 ? "Just Starting" : koreanLevels[currentKoreanLevel - 1]} />
      ...
      <div>
        ...
        <div className="flex overflow-x-auto pb-6 gap-4 no-scrollbar snap-x px-2">
          <PhaseCard title="Phase 1 🚀" desc="Courses + Remaining HiSET Subjects + Casual Korean" date="Aug 2026–Apr 2027" color="border-t-[#ce1126] hover:shadow-[#ce1126]/20" />
          ...
          <PhaseCard title="Phase 4 🎨" desc="Grow Content + Art Practice + Conversational Korean" date="2028–2029" color="border-t-[#4ade80] hover:shadow-[#4ade80]/20" />
