    ...
    <div className="space-y-6">
      ...
      <div className="group bg-gradient-to-br from-[#ce1126]/90 via-[#0a3d8f]/80 to-[#050811] rounded-3xl p-6 sm:p-8 shadow-2xl shadow-[#ce1126]/20 border border-white/10 relative overflow-hidden transition-all duration-500 hover:shadow-[#ce1126]/40 backdrop-blur-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-zinc-200 font-medium text-sm sm:text-lg mb-8 tracking-wide drop-shadow-sm">
            10-Year Master Plan: IT Vocational School in Japan 🎯
          </p>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 font-mono text-xs font-bold">
            ...
            <span className="bg-white/10 px-4 py-2 rounded-xl border border-white/20 backdrop-blur-md text-[#4ade80] flex items-center gap-2 shadow-lg">
              <span className="text-lg">🇯🇵</span> Japan Move: ~2036
            </span>
      ...
      <div>
        ...
        <div className="flex overflow-x-auto pb-6 gap-4 no-scrollbar snap-x px-2">
          <PhaseCard title="Phase 1 🚀" desc="Web Engineering Bootcamp + Japanese + HiSET" date="Sept 2026–Apr 2027" color="border-t-[#ce1126] hover:shadow-[#ce1126]/20" />
          <PhaseCard title="Phase 2 🎓" desc="Courses Complete, Build Web Portfolio" date="Apr–Aug 2027" color="border-t-[#0a3d8f] hover:shadow-[#0a3d8f]/20" />
          <PhaseCard title="Phase 3 💼" desc="Land Dev Job / Freelance + Keep Learning Japanese" date="Aug–Dec 2027" color="border-t-[#f5a623] hover:shadow-[#f5a623]/20" />
          <PhaseCard title="Phase 4 🎥" desc="Gain Years of Web Dev Experience + Reach JLPT N2" date="2028–2029" color="border-t-[#4ade80] hover:shadow-[#4ade80]/20" />
          <PhaseCard title="Phase 5 💰" desc="Save $20k+ for Japan Language/Vocational School Visa" date="2029–2030" color="border-t-[#ce1126] hover:shadow-[#ce1126]/20" />
          <PhaseCard title="Phase 6 🌟" desc="Move to Japan! IT Vocational School -> Web Engineer Job in Japan" date="2030–2036" color="border-t-[#0a3d8f] hover:shadow-[#0a3d8f]/20" />
        </div>
      </div>
    </div>
  );
