...
<<<<<<< HEAD
  { time: "6:15 AM", task: "☕ Make Iced Matcha Latte", dur: "10min" },
  { time: "6:30 AM", task: "🧼 Morning hygiene + mobility", dur: "15min" },
  { time: "7:00 AM", task: "🇯🇵 Japanese — Anki flashcards", dur: "30min", habitId: "h1" },
  { time: "7:30 AM", task: "🇯🇵 Japanese — Grammar/JLPT Bootcamp", dur: "60min", habitId: "h2" },
=======
...
<<<<<<< HEAD
  { time: "3:00 PM", task: "🇯🇵 Japanese Immersion (music/podcasts/anime)", dur: "30min" },
  { time: "3:30 PM", task: "🥛 Snack — Greek yogurt", dur: "10min" },
  { time: "5:00 PM", task: "🎨 Art / Japanese culture / rest", dur: "90min", habitId: "h6" },
  { time: "7:00 PM", task: "🍚 Dinner", dur: "30min" },
  { time: "8:00 PM", task: "🇯🇵 Night Japanese — shadowing/anime", dur: "30min" },
=======
...
<<<<<<< HEAD
                <StudyBlock title="🇯🇵 Japanese" dur="90m" color="bg-[#ce1126]/10 text-[#ce1126] border-[#ce1126]/30 hover:bg-[#ce1126]/20 hover:border-[#ce1126]/50" />
=======
