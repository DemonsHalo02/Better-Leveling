...
const HORARIO = [
  ...
  { time: "7:00 AM", task: "🇪🇸 Spanish — Anki flashcards", dur: "20min", habitId: "h1" },
  { time: "7:20 AM", task: "🇪🇸 Spanish — Duolingo/podcast (casual)", dur: "30min", habitId: "h2" },
  ...
  { time: "8:00 PM", task: "🇪🇸 Casual Spanish — reading/show with subtitles", dur: "30min" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
            {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, dIdx) => (
              <div key={dIdx} className="bg-black/30 border border-white/5 rounded-2xl p-3 flex flex-col gap-3 shadow-inner">
                ...
                <StudyBlock title="🇪🇸 Spanish" dur="50m" color="bg-[#ce1126]/10 text-[#ce1126] border-[#ce1126]/30 hover:bg-[#ce1126]/20 hover:border-[#ce1126]/50" />
