...
const HORARIO = [
  ...
  { time: "5:10 AM", task: "☕ Brew Starbucks Black Iced Coffee", dur: "10min" },
  ...
  { time: "9:35 AM", task: "🚿 Shower + recovery", dur: "20min" },
  { time: "9:55 AM", task: "🍳 Post-workout meal", dur: "25min" },
  { time: "11:15 AM", task: "💻 Microsoft Study Block 1", dur: "90min", habitId: "h4" },
  { time: "12:45 PM", task: "🍱 Lunch — Korean rice bowl + kimchi", dur: "30min" },
  { time: "1:15 PM", task: "💻 Microsoft Study Block 2", dur: "60min", habitId: "h5" },
  { time: "2:15 PM", task: "🇰🇷 Korean immersion (music/podcasts/TV)", dur: "30min" },
  { time: "2:45 PM", task: "🥛 Snack — Greek yogurt", dur: "10min" },
  { time: "4:15 PM", task: "🎨 Art / study / rest", dur: "90min", habitId: "h6" },
  { time: "6:15 PM", task: "🍚 Dinner — gochujang chicken + rice + broccoli", dur: "30min" },
  { time: "7:15 PM", task: "🇰🇷 Night Korean — dramas/shadowing", dur: "30min" },
  { time: "7:45 PM", task: "📓 Journal + plan tomorrow", dur: "20min", habitId: "h7" },
  { time: "8:30 PM", task: "📵 Screens off", dur: "" },
