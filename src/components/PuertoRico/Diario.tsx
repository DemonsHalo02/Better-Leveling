...
const HORARIO = [
  ...
  { time: "7:30 AM", task: "🇰🇷 Korean — Grammar/textbook", dur: "60min", habitId: "h2" },
  ...
  { time: "3:00 PM", task: "�🇷 Korean immersion (music/podcasts/TV)", dur: "30min" },
  ...
  { time: "8:00 PM", task: "�🇷 Night Korean — dramas/shadowing", dur: "30min" },
