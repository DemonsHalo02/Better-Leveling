...
const HORARIO = [
  ...
  { time: "7:30 AM", task: "� Pre-workout banana", dur: "5min" },
  { time: "7:35 AM", task: "🏋️ Workout (Mon-Sat)", dur: "75–90min", habitId: "h3" },
  { time: "9:05 AM", task: "🧘 Cool down + stretch", dur: "15min" },
  { time: "9:20 AM", task: "🚿 Shower + recovery", dur: "20min" },
  { time: "9:40 AM", task: "🍳 Post-workout meal", dur: "25min" },
  { time: "11:00 AM", task: "💻 Microsoft Study Block 1", dur: "90min", habitId: "h4" },
