            ...
            {projectedTotal < goal && (
              <div className="mt-4 bg-[#ce1126]/10 border border-[#ce1126]/30 p-3 rounded-xl">
                <p className="text-[11px] font-medium text-[#ce1126] leading-relaxed">
                  <span className="font-bold">Warning:</span> Current surplus trajectory falls short of the $15k goal within 24 months. Consider increasing income (freelance gigs, content monetization) to cover the MacBook Pro + iPad Pro + emergency fund!
                </p>
              </div>
            )}
          </div>
          ...
          <form onSubmit={handleAddEntry} className="space-y-5">
            ...
            <div>
              ...
              <input 
                ...
                placeholder="Ex. Paycheck, freelance..."
