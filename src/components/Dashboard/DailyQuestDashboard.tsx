        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2 flex-1">
            ...
            <p className="text-xs text-zinc-300 max-w-2xl leading-relaxed">
              Every clean meal prep and every PR at {state.profile.gymName || 'your K-Pop Idol Style Home Bodyweight Dojo or Planet Fitness Gym'} chops HP off this boss raid. Stay consistent on your chosen {state.profile.dietName || '19-Country Global S-Rank Meal Blueprint'} to avoid loose skin and emerge at peak definition!
            </p>
