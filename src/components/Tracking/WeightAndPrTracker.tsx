      ...
      <div className="bg-system-panel p-6 rounded-2xl border border-white/10 space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
          <div>
            ...
            <p className="text-xs text-zinc-400">Log your heaviest reps or resistance progression during Quiet Apartment Dojo Workouts to level up your STR stat!</p>
          </div>
          <button
        ...
        <div className="bg-system-card p-4 rounded-xl border border-system-gold/30 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Every personal record logged during your Quiet Apartment Dojo Workout increases your STR stat by +1 and awards 150 XP!</p>
            </div>
          </div>
