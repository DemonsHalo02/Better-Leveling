        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono">
          <div className="bg-system-dark/80 p-4 rounded-xl border border-system-blue/30 space-y-2">
            ...
            <p className="text-xs text-zinc-300 leading-relaxed">
              At <strong>{currentWeight} LBS</strong>, you have <strong>{lbsRemaining} LBS</strong> left to shred. Your current pace preserves maximum muscle. <strong>AI Recommendation:</strong> Keep hitting your 45-minute daily dual cardio (30m walk + 15m run) right after your Quiet Apartment Bodyweight Dojo workouts!
            </p>
          </div>
