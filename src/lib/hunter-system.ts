...
const DEFAULT_STATE: HunterState = {
  ...
  profile: {
    ...
    dietName: "Healthy Crispy Fried Korean Gochujang Chicken & Regular Dunkin' Black Coffee Shred Blueprint",
  },
  completedQuestsToday: {
    workout: false,
    calories: false,
...
export function loadHunterState(): HunterState {
  ...
  try {
    ...
    if (parsed.profile) {
      ...
      if (parsed.profile.dietName !== "Healthy Crispy Fried Korean Gochujang Chicken & Regular Dunkin' Black Coffee Shred Blueprint") {
        parsed.profile.dietName = "Healthy Crispy Fried Korean Gochujang Chicken & Regular Dunkin' Black Coffee Shred Blueprint";
        needsSave = true;
      }
