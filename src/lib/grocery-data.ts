...
export const MEAL_PREP_PLANS: MealPrepPlan[] = [
  ...
  {
    id: "plan-japan",
    title: "Japan: Pan/Oven Crispy Teriyaki Chicken, Steamed Rice & Dirty Matcha Latte Shred Blueprint (~2,080 kcal)",
    country: "Japan",
    flag: "🇯🇵",
    ...
    targetDailyProtein: 178,
    estCostPerWeek: "$45.50 Weekly Consumables / $14.10 Periodic Restock ($59.60 Combined Total)",
    description: "Authentic Japanese Crispy Teriyaki Chicken paired with Steamed White Rice and Garlic/Ginger Aromatics. Features morning Scallion Scramble, Dirty Matcha Latte (Starbucks K-Cup + Matcha), Casein bowls, and Nissin Raoh Soy Sauce Ramen with Crispy Teriyaki Chicken reward treat!",
    meals: createMeals(
