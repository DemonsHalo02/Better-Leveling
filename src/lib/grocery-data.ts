...
export const AUBURN_LEWISTON_GROCERY_ITEMS: GroceryItem[] = [
  ...
  },
  {
    ...
    coachNote: "Authentic sweet & savory General Tso's glaze stocked at Auburn Maine Walmart! Toss chicken cubes lightly in 1 tsp cornstarch and garlic powder, sear, then glaze with Panda Express General Tso's sauce (Periodic Monday Restock item).",
    cuisine: ["China", "China Bulking"]
  },
  {
    id: "g-13",
    ...
    meals: [
      {
        ...
        ingredients: [
          "1 Pre-Workout Death Wish Iced Black Coffee: Brew 2 tbsp Death Wish Espresso Roast ground coffee with hot water, pour over ice (optional: add 1 zero-cal sweetener packet or keep pure black). High-octane clean caffeine to ignite thermogenesis and intense focus for gym volume! (5 kcal, 0g p)",
          "1 Medium Fresh Banana (~118g): Peel and eat immediately right before leaving for Planet Fitness Lewiston for rapid-absorbing carbohydrates & potassium to top off liver glycogen! (105 kcal, 1g p, 27g c)"
        ],
        calories: 110,
        protein: 1,
        carbs: 27,
      ...
      {
        name: "Post-Workout Breakfast: Chinese Scallion & Liquid Egg White Scramble + Chili Garlic + Tea",
        time: "10:30 AM – 11:00 AM (Post-Workout)",
        ingredients: [
          "3 Whole Grade A White Eggs + 1/2 cup (4 oz) Liquid Egg Whites scrambled in Great Value 0-Cal Cooking Spray. Cooking Instructions: Whisk whole eggs and liquid whites thoroughly. Spray non-stick skillet over medium heat, gently scramble for 2-3 mins. Fold in 1 tbsp soy sauce, 1/2 tsp garlic powder, and chopped fresh green onions (scallions) until fluffy! Delivers rich amino acids and clean bio-available protein. (240 kcal, 31g p, 11g f)",
          "1 cup cooked Long Grain White Rice (from batch prep, reheated with a splash of water for rapid glycogen replenishment post-workout). (200 kcal, 4g p, 44g c)",
      ...
      {
        name: "Lunch: Wok-Seared Chinese General Tso's Chicken + White Rice & Steamed Broccoli + Tea",
        time: "2:00 PM – 2:30 PM",
        ingredients: [
          "~5.7 oz Fresh Chicken Breast cubes wok-seared in Chinese General Tso's Glaze. Cooking Instructions: Cut chicken breast into bite-sized cubes, toss lightly with 1/2 tsp cornstarch and garlic powder. Spray wok with 0-cal canola spray, sear 6-8 minutes until golden and 165°F internal. Whisk low-cal General Tso's Glaze (1.5 tbsp Panda Express sauce, 1 tsp soy sauce, 1 zero-cal sweetener packet, 1/4 tsp ginger, 1/4 tsp garlic powder, 1 tbsp water), pour into wok and toss for 1 minute until sticky, glossy, and caramelized! (210 kcal, 40g p, 2g f)",
          "1 cup cooked Long Grain White Rice (from batch prep, reheated warm and fluffy). (200 kcal, 4g p, 44g c)",
      ...
      {
        name: "Dinner: Wok-Seared Chinese General Tso's Chicken + White Rice & Steamed Broccoli + Tea",
