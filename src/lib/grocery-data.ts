...
export const AUBURN_LEWISTON_GROCERY_ITEMS: GroceryItem[] = [
  ...
  // 8. 🇰🇷 Korea
  {
    ...
    name: "Fresh Garlic, Ginger & Green Onions / Cabbage Kimchi Base",
    store: "Walmart Supercenter (Auburn, ME)",
    brand: "Fresh Produce / Jongga",
    category: "Produce",
    priceEst: "$2.86 (Fresh aromatics & Kimchi jar)",
    calories: 25,
    protein: 1,
    carbs: 5,
    fat: 0,
  ...
  },
  {
    id: "g-korea-tea",
    upc: "078742356608",
    name: "Dongseo Roasted Barley Tea (Bori-cha) Bags & Matcha (100 ct)",
    store: "Walmart Supercenter (Auburn, ME)",
    brand: "Dongseo / Asian Tea",
    category: "Essentials",
    priceEst: "$4.88 (100 Count Box)",
    calories: 0,
    protein: 0,
  ...
  },
  {
    id: "g-korea-reward",
    upc: "078742355508",
    name: "Shin Ramyun Gourmet Spicy Bowl / Kimchi Pancakes (Weekly Reward Treat)",
    store: "Walmart Supercenter (Auburn, ME)",
    brand: "Nongshim / Frozen",
    category: "Carbs",
    priceEst: "$3.48 (4-Pack bowl/mix)",
    calories: 160,
    protein: 4,
    carbs: 28,
    fat: 4,
