...
export const AUBURN_LEWISTON_GROCERY_ITEMS: GroceryItem[] = [
  ...
  },
  {
    ...
    coachNote: "Authentic sweet & savory Korean BBQ / Gochujang glaze stocked at Auburn Maine Walmart! Toss chicken cubes lightly in 1 tsp cornstarch and garlic powder, sear, then glaze (Periodic Monday Restock item).",
    cuisine: ["Korea", "Korea Bulking"]
  },
  {
    id: "g-13",
  ...
  },
  {
    ...
    coachNote: "High-octane Death Wish Espresso Roast! Brew over ice for your 8:00 AM Pre-Workout Iced Black Coffee fuel right before your K-Pop Idol Home Bodyweight Dojo session.",
    cuisine: ["Korea", "Korea Bulking"]
  },
  {
    id: "g-16",
...
export const MEAL_PREP_PLANS: MealPrepPlan[] = [
  {
    id: "plan-korea",
    title: "Korea: Korean Gochujang Chicken & Death Wish Black Coffee Shred Blueprint (~2,080 kcal)",
    country: "Korea",
    flag: "🇰🇷",
    ...
    description: "The #1 Main Korean Gochujang Chicken & Death Wish Black Coffee Shred Blueprint! Tailored specifically for steady, sustainable fat loss (~0.75-1.0 lb/wk) to reach your 160 lb target cleanly by 2028 without loose skin or muscle loss. Designed around your exact schedule: Monday Grocery Run at Auburn Maine Walmart Supercenter ($50 budget limit) & Batch Meal Prep, starting eating Tuesday (7-Day Cycle). Features high-octane Death Wish Espresso Roast Iced Black Coffee + Banana at 8:00 AM as extreme Pre-Workout focus before hitting your K-Pop Idol Home Bodyweight Dojo session & 45m dual cardio walk/run! Followed by a cooked-fresh Post-Workout Scallion & Liquid Egg White Scramble with Kimchi between 10:30-11:00 AM, authentic Wok-Seared Korean Gochujang Chicken for Lunch and Dinner, and slow-release Casein Greek Yogurt bowls (with 4 tubs / 1 Gallon guaranteed so you never run out!). Traditional 100% Green Tea is paired with every post-workout main meal. Plus, includes your once-a-week Samyang Buldak Korean Ramen reward treat meal on Friday or Saturday evening and periodic Salmon restocks for essential Omega-3s!",
    meals: [
      {
      ...
      {
        name: "Dinner: Wok-Seared Korean Gochujang Chicken & Steamed Broccoli + Tea",
        time: "7:30 PM – 8:00 PM",
        ingredients: [
          "~5.7 oz Fresh Chicken Breast cubes wok-seared in Korean Gochujang Glaze. Cooking Instructions: Prepare chicken cubes in wok with 0-cal canola spray over medium-high heat for 6-8 minutes. Toss with low-cal Gochujang Glaze until caramelized and glossy! (210 kcal, 40g p, 2g f)",
  ...
  },
  {
    ...
    meals: [
      ...
      },
      {
        ...
        time: "2:00 PM – 2:30 PM",
        ingredients: [
          "~5.7 oz Fresh Chicken Breast cubes wok-seared in Korean Gochujang Glaze. Cooking Instructions: Cut chicken breast into bite-sized cubes, toss with 1 tsp cornstarch and garlic powder. Spray wok with 0-cal canola spray, sear 6-8 minutes until golden and 165°F internal. Whisk low-cal Gochujang Glaze, pour into wok and toss for 1 minute until sticky and glossy! (210 kcal, 40g p, 2g f)",
      ...
      },
      {
        ...
        time: "7:30 PM – 8:00 PM",
        ingredients: [
          "~5.7 oz Fresh Chicken Breast cubes wok-seared in Korean Gochujang Glaze until caramelized and glossy. (210 kcal, 40g p, 2g f)",
