...
export const AUBURN_LEWISTON_GROCERY_ITEMS: GroceryItem[] = [
  // Primary Lean Protein Base (Shared by ALL 19 countries)
  {
    ...
    category: "Protein",
    priceEst: "$11.98 (~5.0 lb family pack at $2.40/lb)",
    calories: 120,
    protein: 26,
    carbs: 0,
    fat: 1.5,
  ...
  // Eggs (Shared by ALL 19 countries)
  {
    ...
    brand: "Great Value",
    category: "Protein",
    priceEst: "$5.98 (36 count tray / 2 cartons)",
    calories: 70,
    protein: 6,
    carbs: 0,
    fat: 5,
  ...
  // Bananas (Shared pre-workout energy across all countries)
  {
    ...
    brand: "Fresh Produce",
    category: "Produce",
    priceEst: "$0.98 (~2 lb bunch at $0.49/lb)",
    calories: 105,
    protein: 1,
    carbs: 27,
    fat: 0,
  ...
  // Scallions / Green Onions (Shared aromatic base)
  {
    ...
    brand: "Fresh Produce",
    category: "Produce",
    priceEst: "$1.28 (Two bunches at $0.64 ea)",
    calories: 10,
    protein: 1,
    carbs: 2,
    fat: 0,
  ...
  },
  {
    ...
    coachNote: "Your once-a-week fiery Korean reward treat! Samyang Spicy Buldak Ramen Noodles paired with crispy chicken to satisfy intense spice cravings and keep you mentally locked into your 160 lb target (Periodic restock item).",
    cuisine: ["Korea", "Korea Bulking"]
  },
  ...
  // 9. 🇯🇵 Japan (MOST IMPORTANT)
  {
    ...
    coachNote: "Fresh ginger, garlic, and green onions essential for authentic Japanese Crispy Teriyaki Chicken bowls and morning egg scrambles.",
  ...
  },
  {
    ...
    category: "Essentials",
    priceEst: "$9.98 (1.06 oz pouch ~30 servings)",
    calories: 0,
    protein: 0,
    carbs: 0,
    fat: 0,
    servingSize: "1 tsp powder (2g)",
    coachNote: "Authentic Japanese ceremonial-grade matcha green tea for clean morning L-theanine + caffeine focus right before your 8:00 AM workout! (Periodic restock item).",
    cuisine: ["Japan", "Japan Bulking"]
  },
  {
    id: "g-japan-spices",
