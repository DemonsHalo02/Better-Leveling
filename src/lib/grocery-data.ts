...
export const AUBURN_LEWISTON_GROCERY_ITEMS: GroceryItem[] = [
  ...
  },
  {
    ...
    brand: "Hillshire Farm",
    category: "Protein",
    priceEst: "$16.98 (Four packs at $4.25 ea)",
    calories: 180,
    protein: 6,
    carbs: 2,
    fat: 16,
  ...
  },
  {
    id: "g-pr-coffee",
    upc: "078742356601",
    name: "Café Bustelo Espresso Dark Roast Ground Coffee (10 oz brick)",
    store: "Walmart Supercenter (Auburn, ME)",
    brand: "Café Bustelo",
    category: "Essentials",
  ...
  },
  {
    ...
    coachNote: "Authentic Puerto Rican spice and sofrito base giving your chicken and rice intense savory flavor (Periodic restock item).",
    cuisine: ["Puerto Rico", "Puerto Rico Bulking"]
  },
  {
    id: "g-pr-reward",
...
export const MEAL_PREP_PLANS: MealPrepPlan[] = [
  // 1. Puerto Rico 🇵🇷 (Cutting & Bulking)
  {
    ...
    estCostPerWeek: "$49.62 Weekly Consumables / $24.80 Periodic Restock ($74.42 Combined Total)",
  ...
  },
  {
    ...
    estCostPerWeek: "$50.98 Weekly Consumables / $25.20 Periodic Restock ($76.18 Combined Total)",
