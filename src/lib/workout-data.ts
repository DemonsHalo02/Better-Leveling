...
// Quiet, apartment-friendly, mat-only exercises.
...
const DAILY_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    reps: "Until failure",
    equipment: "Mat Only",
    coachTip: "Full range of motion — chest touches the floor. Drop to knees if needed. Keep it controlled and silent on the mat. Log every rep of each set!",
    untilFailure: true,
  },
  {
    id: "kp-situps",
    name: "Idol Core Sit-Ups",
    targetGroup: "Abs",
    sets: 3,
    reps: "Until failure",
    equipment: "Mat Only",
    coachTip: "Hands behind your head or crossed over chest. Come all the way up until elbows touch knees, then lower slowly. Exhale on the way up. No loud thuds.",
    untilFailure: true,
  },
  {
    id: "kp-squats",
    name: "Silent Bodyweight Squats",
    targetGroup: "Legs",
    sets: 3,
    reps: "Until failure",
    equipment: "Bodyweight Only",
    coachTip: "Feet shoulder-width apart, toes slightly out. Squat until thighs are parallel. Drive through your heels to stand. Absolutely no jumping to keep it apartment-friendly.",
    untilFailure: true,
  },
];
...
export const PUERTO_RICAN_HOME_BODYWEIGHT_ROUTINE: WorkoutDay[] = [
  {
    dayOfWeek: 0,
    dayName: "Sunday",
    splitName: "K-Pop Idol Daily Training",
    isRestDay: false,
    questTitle: "[Daily Quest] K-Pop Idol Fitness Routine",
    description: "Run for 15 minutes then complete 3 sets each of quiet push-ups, sit-ups, and squats — all until failure. Log your reps to track personal records. Do this every single day until you hit your goal weight.",
    xpReward: 400,
