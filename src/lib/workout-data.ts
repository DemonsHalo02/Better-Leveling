...
export const CALISTHENICS_BEGINNER: WorkoutDay[] = [
  {
    ...
    "description": "A fundamental bodyweight routine to build baseline strength using just a mat and a chair. Includes daily 15-minute run.",
    "xpReward": 400,
    "exercises": [
      {
        "id": "cal-run",
...
export const CALISTHENICS_INTERMEDIATE: WorkoutDay[] = [
  {
    ...
    "description": "Elevate your bodyweight control with more challenging leverage and deeper ranges of motion. Includes daily 15-minute run.",
    "xpReward": 500,
    "exercises": [
      {
        "id": "cal-run",
...
export const CALISTHENICS_ADVANCED: WorkoutDay[] = [
  {
    ...
    "description": "High-tension bodyweight mastery focusing on unilateral strength and advanced core control. Includes daily 15-minute run.",
    "xpReward": 600,
    "exercises": [
      {
        "id": "cal-run",
...
export const CALISTHENICS_EXPERT: WorkoutDay[] = [
  {
    ...
    "description": "Elite bodyweight manipulation. Requires immense balance, core strength, and joint stability. Includes daily 15-minute run.",
    "xpReward": 800,
    "exercises": [
      {
        "id": "cal-run",
