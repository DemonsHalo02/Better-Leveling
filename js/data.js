...
const QUEST_POOL = [
  // ── STRENGTH (bodyweight — no equipment needed) ──────
  ...
  { id: 'pushups200',   name: 'Complete 200 push-ups today',       xp: 55, stat: 'str',   category: 'strength',  icon: '💪' },
  ...
  { id: 'squats250',    name: 'Complete 250 bodyweight squats',    xp: 50, stat: 'str',   category: 'strength',  icon: '🦵' },
  ...
  { id: 'lunges150',    name: 'Do 150 reverse lunges',             xp: 40, stat: 'str',   category: 'strength',  icon: '🦵' },
  ...
  { id: 'wallsit5',     name: 'Hold a wall sit for 5 minutes total',xp:35, stat: 'vit',   category: 'strength',  icon: '🧱' },
  { id: 'armday',       name: 'Complete a full upper body session', xp: 40, stat: 'str',   category: 'strength',  icon: '💪' },
  { id: 'core20',       name: 'Do 20 min of core work',            xp: 28, stat: 'str',   category: 'strength',  icon: '🔥' },
  { id: 'glutes',       name: 'Do 100 glute bridges + 50 donkey kicks', xp: 30, stat: 'str', category: 'strength', icon: '🦵' },
  { id: 'mountain100',  name: 'Do 100 mountain climbers',          xp: 30, stat: 'str',   category: 'strength',  icon: '🔥' },
  { id: 'dips60',       name: 'Do 60 chair/bench tricep dips',     xp: 30, stat: 'str',   category: 'strength',  icon: '💪' },
  { id: 'inchworm',     name: 'Do 30 inchworm walkouts',           xp: 25, stat: 'str',   category: 'strength',  icon: '🤸' },
  { id: 'pikepush',     name: 'Do 50 pike push-ups',               xp: 30, stat: 'str',   category: 'strength',  icon: '💪' },
  { id: 'bearcrawl',    name: 'Bear crawl for 10 minutes',         xp: 30, stat: 'str',   category: 'strength',  icon: '🔥' },
  { id: 'stretch20',    name: 'Do 20 min full-body stretching',    xp: 20, stat: 'agi',   category: 'strength',  icon: '🤸' },
  // Pull-up bar alternatives (clearly labeled)
  { id: 'pullups20',    name: 'Do 20 pull-ups (bar required)',      xp: 30, stat: 'str',   category: 'strength',  icon: '🏋️', needsEquip: true, altId: 'pullalt20' },
  { id: 'pullups50',    name: 'Do 50 pull-ups (bar required)',      xp: 45, stat: 'str',   category: 'strength',  icon: '🏋️', needsEquip: true, altId: 'pullalt50' },
  { id: 'pullalt20',    name: 'Do 80 rows using a table edge',      xp: 30, stat: 'str',   category: 'strength',  icon: '💪' },
  { id: 'pullalt50',    name: 'Do 150 wide push-ups + 60 rows',    xp: 45, stat: 'str',   category: 'strength',  icon: '💪' },
  { id: 'muscleups',    name: 'Do 10 muscle-ups (bar required)',    xp: 45, stat: 'str',   category: 'strength',  icon: '🏋️', needsEquip: true, altId: 'musclealt' },
  { id: 'musclealt',    name: 'Do 100 explosive push-ups + 50 jump squats', xp: 45, stat: 'str', category: 'strength', icon: '🔥' },
  ...
  { id: 'hiit30',       name: 'Complete 30 min HIIT session',      xp: 55, stat: 'agi',   category: 'cardio',    icon: '🔥' },
  ...
  { id: 'shadowbox30',  name: 'Shadow box for 30 minutes',         xp: 50, stat: 'agi',   category: 'cardio',    icon: '🥊' },
  ...
  { id: 'jumpjacks500', name: 'Do 500 jumping jacks',              xp: 35, stat: 'agi',   category: 'cardio',    icon: '⚡' },
  { id: 'highknees',    name: 'Do 5 min of high knees x 3 sets',   xp: 30, stat: 'agi',   category: 'cardio',    icon: '🏃' },
  { id: 'stairs',       name: 'Climb 20 flights of stairs',        xp: 35, stat: 'vit',   category: 'cardio',    icon: '🪜' },
  // Equipment optional — alternatives shown
  { id: 'jump500',      name: '500 jump rope reps (rope optional)',  xp: 30, stat: 'agi',  category: 'cardio',    icon: '⚡', needsEquip: true, altId: 'jumpalt500' },
  { id: 'jump1000',     name: '1,000 jump rope reps (rope optional)',xp: 45, stat: 'agi',  category: 'cardio',    icon: '⚡', needsEquip: true, altId: 'jumpalt1000' },
  { id: 'jumpalt500',   name: 'Do 500 jumping jacks instead',       xp: 30, stat: 'agi',   category: 'cardio',    icon: '⚡' },
  { id: 'jumpalt1000',  name: 'Do 800 jumping jacks instead',       xp: 45, stat: 'agi',   category: 'cardio',    icon: '⚡' },
  { id: 'bike10',       name: 'Cycle 10 km (bike required)',         xp: 45, stat: 'agi',   category: 'cardio',    icon: '🚴', needsEquip: true, altId: 'bikealt10' },
  { id: 'bike20',       name: 'Cycle 20 km (bike required)',         xp: 65, stat: 'agi',   category: 'cardio',    icon: '🚴', needsEquip: true, altId: 'bikealt20' },
  { id: 'bikealt10',    name: 'Run 4 km or walk 8,000 steps instead', xp: 45, stat: 'agi', category: 'cardio',    icon: '🏃' },
  { id: 'bikealt20',    name: 'Run 8 km or do 45-min HIIT instead',  xp: 65, stat: 'agi',  category: 'cardio',    icon: '🏃' },
  { id: 'swim',         name: 'Swim for 30 minutes (pool required)', xp: 50, stat: 'agi',   category: 'cardio',    icon: '🏊', needsEquip: true, altId: 'swimalt' },
  { id: 'swimalt',      name: '20 min HIIT + 10 min shadowboxing',   xp: 50, stat: 'agi',   category: 'cardio',    icon: '🥊' },
